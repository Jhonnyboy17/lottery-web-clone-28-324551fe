...
const games: NumbersGame[] = [
  ...
  },
  {
    ...
    date: "Terça-feira, 25 de março de 2025",
    drawTime: "Dia",
    numbers: [
      { value: "8", color: "bg-[#00ccc6]" },
      { value: "18", color: "bg-[#00ccc6]" },
      { value: "21", color: "bg-[#00ccc6]" },
      { value: "27", color: "bg-[#00ccc6]" },
      { value: "30", color: "bg-[#00ccc6]" },
    ],
  },
  {
    id: 4,
    ...
    numbers: [
      { value: "3", color: "bg-[#8CD444]" },
      { value: "24", color: "bg-[#8CD444]" },
      { value: "27", color: "bg-[#8CD444]" },
      { value: "34", color: "bg-[#8CD444]" },
      { value: "38", color: "bg-[#8CD444]" },
    ],
  },
  {
    id: 5,
