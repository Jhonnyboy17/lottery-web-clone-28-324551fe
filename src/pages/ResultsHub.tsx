...
import { Search, ArrowLeft, CalendarDays, ArrowRight, FileText, ChevronRight, ChevronDown, Check, Eye } from "lucide-react";
...
const ResultsHub = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#272331] results-hub">
      <Navbar />
      ...
      <div className="container mx-auto max-w-6xl px-4 pt-24 pb-16">
        ...
        <div className="relative mb-8" ref={dropdownRef}>
          <Button 
            ...
            className="flex items-center justify-between w-full md:w-64 text-left font-medium"
          >
          ...
          {showGamesDropdown && (
            <div className="absolute mt-2 p-6 bg-white dark:bg-lottery-dark-card rounded-lg shadow-lg w-full md:w-[820px] z-50 animate-in fade-in duration-200">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {lotteryGames.map((game) => (
                  <div 
                    key={game.id} 
                    className={`${game.backgroundColor} rounded-lg overflow-hidden`}
                  >
                    <div className="p-4 flex flex-col items-center">
                      <img src={game.logoSrc} alt={game.name} className="h-12 w-auto mb-3" />
                      <p className="text-xl font-bold text-black">${game.amount}</p>
                      ...
                      <div className="flex flex-col w-full space-y-2 mt-3">
                        <button 
                          ...
                          className="w-full bg-black/10 hover:bg-black/20 text-black rounded-full px-4 py-1.5 text-sm font-bold flex items-center justify-center"
                        >
        ...
        <Tabs value={activeGame} onValueChange={setActiveGame} className="mb-8">
          <TabsList className="grid grid-cols-2 md:grid-cols-4 gap-2 bg-transparent">
            <TabsTrigger 
              value="mega-millions"
              className="data-[state=active]:bg-blue-100 data-[state=active]:text-blue-700 border rounded-md dark:data-[state=active]:bg-blue-900 dark:data-[state=active]:text-blue-100"
            >
            ...
            <TabsTrigger 
              value="powerball"
              className="data-[state=active]:bg-red-100 data-[state=active]:text-red-700 border rounded-md dark:data-[state=active]:bg-red-900 dark:data-[state=active]:text-red-100"
            >
            ...
            <TabsTrigger 
              value="lucky-day"
              className="data-[state=active]:bg-green-100 data-[state=active]:text-green-700 border rounded-md dark:data-[state=active]:bg-green-900 dark:data-[state=active]:text-green-100"
            >
            ...
            <TabsTrigger 
              value="pick4"
              className="data-[state=active]:bg-cyan-100 data-[state=active]:text-cyan-700 border rounded-md dark:data-[state=active]:bg-cyan-900 dark:data-[state=active]:text-cyan-100"
            >
          ...
          <div className="mt-4 flex flex-col sm:flex-row gap-2 mb-6">
            <Link 
              to={`/play-${activeGame}`}
              className="inline-flex items-center justify-center text-center font-medium bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-md px-4 py-2 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200"
            >
          ...
          <TabsContent value={activeGame} className="mt-2">
            <div className="bg-white dark:bg-[#2D2936] rounded-lg shadow-sm border dark:border-[#3a3644] p-6">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
                ...
                <div className="relative w-full md:w-64">
                  ...
                  <input 
                    ...
                    className="border rounded-full py-2 pl-10 pr-4 w-full focus:outline-none focus:ring-2 focus:ring-lottery-navy/50 dark:bg-[#2a2a2a] dark:border-[#3a3644] dark:text-[#d0d0d0]"
                  />
                </div>
              </div>

              <div className="overflow-x-auto mb-6 dark:table">
                {renderResultsTable()}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Card className="dark:bg-[#2D2936] dark:border-[#3a3644]">
