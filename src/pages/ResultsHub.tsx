...
const ResultsHub = () => {
  ...
  const renderResults = () => {
    switch (selectedGame) {
      case 'megamillions':
        const megaStart = (currentPage - 1) * itemsPerPage;
        const megaEnd = megaStart + itemsPerPage;
        const megaSlice = megaMillionsHistory.slice(megaStart, megaEnd);
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Números Regulares</TableHead>
                <TableHead>Mega Ball</TableHead>
                <TableHead>Multiplicador</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {megaSlice.map((result, idx) => (
                <TableRow key={idx}>
                  <TableCell>
                  ...
                  <TableCell>
                    <div className="flex space-x-1">
                      {result.numbers.map((num, i) => (
                        <div key={i} className="w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center text-sm">
                          {num}
                        </div>
                      ))}
                    </div>
      ...
      case 'powerball':
        const powerStart = (currentPage - 1) * itemsPerPage;
        const powerEnd = powerStart + itemsPerPage;
        const powerSlice = powerballHistory.slice(powerStart, powerEnd);
              ...
              {powerSlice.map((result, idx) => (
                <TableRow key={idx}>
                  ...
                  <TableCell>
                    <div className="flex space-x-1">
                      {result.numbers.map((num, i) => (
                        <div key={i} className="w-8 h-8 rounded-full bg-red-600 text-white flex items-center justify-center text-sm">
                          {num}
                        </div>
                      ))}
                    </div>
                  ...
                  <TableCell>
                    <div className="w-8 h-8 rounded-full bg-red-800 text-white flex items-center justify-center text-sm">
                      {result.powerball}
                    </div>
                  </TableCell>
                  <TableCell>{result.multiplier}</TableCell>
      ...
      case 'luckyday':
        const luckyStart = (currentPage - 1) * itemsPerPage;
        const luckyEnd = luckyStart + itemsPerPage;
        const luckySlice = luckyDayHistory.slice(luckyStart, luckyEnd);
              ...
              {luckySlice.map((result, idx) => (
                <TableRow key={idx}>
                  ...
                  <TableCell>
                    <div className="flex space-x-1">
                      {result.numbers.map((num, i) => (
                        <div key={i} className="w-8 h-8 rounded-full bg-[#8CD444] text-white flex items-center justify-center text-sm">
                          {num}
                        </div>
                      ))}
                    </div>
      ...
      case 'pick4':
        const pick4Start = (currentPage - 1) * itemsPerPage;
        const pick4End = pick4Start + itemsPerPage;
        const pick4Slice = pick4History.slice(pick4Start, pick4End);
              ...
              {pick4Slice.map((result, idx) => (
                <TableRow key={idx}>
                  ...
                  <TableCell>
                    <div className="flex space-x-1">
                      {result.numbers.map((num, i) => (
                        <div key={i} className="w-8 h-8 rounded-full bg-cyan-600 text-white flex items-center justify-center text-sm">
                          {num}
                        </div>
                      ))}
                    </div>
  ...
  const getTotalPages = () => {
    switch (selectedGame) {
      case 'megamillions':
        return Math.ceil(megaMillionsHistory.length / itemsPerPage);
      case 'powerball':
        return Math.ceil(powerballHistory.length / itemsPerPage);
      case 'luckyday':
        return Math.ceil(luckyDayHistory.length / itemsPerPage);
      case 'pick4':
        return Math.ceil(pick4History.length / itemsPerPage);
      default:
        return 1;
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-16 pt-28">
        <div className="flex items-center mb-8">
          ...
          <h1 className="text-3xl font-bold">Central de Resultados</h1>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-lg font-medium">Resultados Recentes</span>
              </div>
        ...
        <Tabs defaultValue="megamillions" className="w-full" onValueChange={handleGameChange}>
          <TabsList className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-8">
            <TabsTrigger value="megamillions" className="data-[state=active]:bg-blue-600 data-[state=active]:text-white">
              Mega Millions
            </TabsTrigger>
            <TabsTrigger value="powerball" className="data-[state=active]:bg-red-600 data-[state=active]:text-white">
              Powerball
            </TabsTrigger>
            <TabsTrigger value="luckyday" className="data-[state=active]:bg-[#8CD444] data-[state=active]:text-white">
              Lucky Day
            </TabsTrigger>
            <TabsTrigger value="pick4" className="data-[state=active]:bg-cyan-600 data-[state=active]:text-white">
              Pick 4
            </TabsTrigger>
          </TabsList>
          
          <TabsContent value="megamillions" className="mt-0">
            {renderResults()}
          </TabsContent>
          
          <TabsContent value="powerball" className="mt-0">
            {renderResults()}
          </TabsContent>
          
          <TabsContent value="luckyday" className="mt-0">
            {renderResults()}
          </TabsContent>
          
          <TabsContent value="pick4" className="mt-0">
            {renderResults()}
          </TabsContent>
        </Tabs>
        ...
        <div className="mt-16 text-center">
          <Button 
            ...
            onClick={() => window.open('/historical-results.pdf', '_blank')}
          >
